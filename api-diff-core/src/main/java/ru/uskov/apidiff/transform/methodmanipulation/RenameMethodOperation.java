...
public class RenameMethodOperation implements TransformOperation {
    ...
    public RenameMethodOperation(Set<ClassInstance> oldApi, ClassInstance oldClass, MethodInstance oldMethod, MethodInstance newMethod, int weight) {
        this.weight = weight;
        this.sourceMethod = oldMethod;
        this.destMethod = ImmutableMethodInstance.copyOf(oldMethod).withName(newMethod.getName());
